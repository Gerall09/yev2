    ...
    ZimBotInc.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                let link = `https://youtu.be/gQ8vGdo9miQ`
let buttons = [
...
title: `Selamat Datang Di Grub Ini Jan Lupa Baca Desc`,
body: `Follow rall_nation09`,
mediaType:2,
thumbnail: buffer,
sourceUrl: link,
mediaUrl: link,
